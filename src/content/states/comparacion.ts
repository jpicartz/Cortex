...
export const comparacion: MentalState = {
  ...
  mechanism: {
    ...
    body: {
      es: [
        'Tu sistema de recompensa no evalúa en absoluto, evalúa en relativo. No calcula "esto es bueno"; calcula "esto es mejor o peor de lo que esperaba". Todo lo que sientes como logro o como fracaso es en realidad una comparación contra un punto de referencia.',
        'Ese punto de referencia no es fijo: lo pones tú, sin darte cuenta, con lo que ves a tu alrededor. Y ahí está el problema con las redes. No te comparas con la gente que conoces, te comparas con una selección de los mejores momentos de miles de personas, ordenados por un algoritmo que premia justo lo que más llama la atención.',
        'Además la comparación siempre es asimétrica. De ellos ves el resultado; de ti vives el proceso completo, con las dudas, el desorden y los intentos fallidos. Estás comparando la portada de alguien más contra tus páginas sueltas. No es que seas peor: es que la información que tienes de cada lado no es del mismo tipo.',
        'Por eso no funciona convencerte de que no deberías compararte. Comparar es automático; no se apaga con voluntad. Lo que sí puedes cambiar es contra qué comparas. Si controlas el punto de referencia —lo que ves, y contra quién te mides— cambias el resultado del cálculo sin tener que ganar la pelea contra ti mismo.',
      ],
      en: [
        'Your reward system does not evaluate in absolute terms, it evaluates relatively. It does not compute "this is good"; it computes "this is better or worse than I expected." Everything you feel as achievement or failure is really a comparison against a reference point.',
        "That reference point isn't fixed — you set it, without noticing, from whatever surrounds you. Which is the problem with feeds. You aren't comparing yourself to people you know; you're comparing yourself to a curated selection of thousands of people's best moments, ranked by an algorithm that rewards precisely what grabs attention.",
        "The comparison is also always asymmetric. From them you see the outcome; from yourself you live the entire process, with the doubt, the mess and the failed attempts. You are comparing someone's cover against your loose pages. It isn't that you're worse — it's that the information you have on each side isn't the same kind.",
        "Which is why convincing yourself you shouldn't compare doesn't work. Comparing is automatic; willpower does not switch it off. What you can change is what you compare against. Control the reference point — what you see, and who you measure against — and you change the result of the calculation without having to win a fight with yourself.",
      ],
    },
    parts: [
      {
