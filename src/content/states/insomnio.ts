...
export const insomnio: MentalState = {
  ...
  mechanism: {
    ...
    body: {
      es: [
        'Dormir no es algo que hagas: es algo que ocurre cuando se juntan dos condiciones. Una es la presión de sueño, que se acumula sola mientras estás despierto. La otra es tu reloj interno, que decide a qué hora tu cuerpo espera dormir. Si las dos están alineadas, te duermes sin hacer nada.',
        'Ninguna de las dos responde al esfuerzo. Al contrario: esforzarte por dormir es una tarea con una meta y una fecha límite, y tu cuerpo la trata como cualquier otra: subiendo la activación. Por eso mirar el reloj y calcular las horas que te quedan es exactamente lo que más te aleja. La preocupación por no dormir es lo que sostiene el no dormir.',
        'Lo de la mente acelerada tiene una explicación más simple de lo que parece. Esos pensamientos estaban ahí todo el día; lo que pasa es que estabas ocupado y no los escuchabas. Al detenerte y quitar los estímulos, la red que produce pensamiento espontáneo por fin tiene el escenario para ella sola. No es que llegaron de noche: es que por fin hay silencio.',
        'Hay otra pieza que casi nadie considera. Si te quedas acostado despierto y frustrado noche tras noche, tu cerebro aprende esa asociación: la cama se convierte en el lugar donde uno está despierto pensando. Cuidar esa asociación importa más de lo que parece, y es la razón del consejo contraintuitivo de levantarse.',
      ],
      en: [
        'Sleep is not something you do — it is something that happens when two conditions line up. One is sleep pressure, which builds on its own while you are awake. The other is your internal clock, which decides when your body expects to sleep. When both align, you fall asleep without doing anything.',
        'Neither responds to effort. Quite the opposite: trying to sleep is a task with a goal and a deadline, and your body treats it like any other — by raising arousal. Which is why checking the clock and counting the hours you have left is precisely what pushes it further away. Worrying about not sleeping is what sustains the not sleeping.',
        'The racing mind has a simpler explanation than it seems. Those thoughts were there all day; you were busy and not listening. Once you stop and remove the stimulation, the network that generates spontaneous thought finally has the stage to itself. They did not arrive at night — there is finally silence.',
        'There is one more piece almost nobody accounts for. If you lie awake and frustrated night after night, your brain learns that association: the bed becomes the place where one lies awake thinking. Protecting that association matters more than it sounds, and it is the reason behind the counterintuitive advice to get up.',
      ],
    },
    parts: [
      {
