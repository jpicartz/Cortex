...
export const miedoAlJuicio: MentalState = {
  ...
  mechanism: {
    ...
    body: {
      es: [
        'Cuando te sientes excluido o juzgado, se activan zonas del cerebro que se solapan con las del dolor físico. No es una metáfora ni una exageración: para tu sistema nervioso, quedar mal frente a un grupo se procesa con parte de la misma maquinaria que un daño corporal.',
        'Tiene sentido si piensas de dónde venimos. Durante casi toda la historia humana, ser expulsado del grupo era una sentencia de muerte. Un cerebro que trataba el rechazo social como una emergencia sobrevivía más. Ese sistema sigue instalado, aunque hoy el peor escenario real sea una reunión incómoda.',
        'Encima de eso corre otro error, y este sí es medible: sobreestimas enormemente cuánto te notan los demás. En los experimentos, la gente calcula que alrededor de la mitad de la sala se dio cuenta de su error o de su ropa rara; el número real ronda el veinte por ciento o menos. Tú eres el protagonista de tu experiencia y das por hecho que también lo eres de la de todos.',
        'La razón es simple: cada persona en esa sala está ocupada preocupándose por cómo se ve ella. Nadie tiene la atención libre para auditarte con el detalle con el que tú te auditas. El público severo que imaginas está, en su mayor parte, pensando en sí mismo.',
      ],
      en: [
        'When you feel excluded or judged, brain regions overlapping with those for physical pain light up. This is not a metaphor or an exaggeration: to your nervous system, looking bad in front of a group is processed with some of the same machinery as bodily harm.',
        'It makes sense given where we come from. For most of human history, being cast out of the group was a death sentence. A brain that treated social rejection as an emergency survived more often. That system is still installed, even though today the realistic worst case is an awkward meeting.',
        'Layered on top is another error, and this one is measurable: you drastically overestimate how much others notice you. In experiments, people guess that around half the room clocked their mistake or their odd shirt; the real figure is nearer twenty percent or less. You are the protagonist of your experience and you assume you are the protagonist of everyone else\'s too.',
        'The reason is simple: every person in that room is busy worrying about how they come across. Nobody has spare attention to audit you with the detail you audit yourself. The harsh audience you are imagining is, for the most part, thinking about itself.',
      ],
    },
    parts: [
      {
